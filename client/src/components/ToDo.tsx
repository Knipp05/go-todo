...
export default function ToDo(props: any) {
  ...
  return (
    <div className="todo">
      <div
        className={props.data.isDone ? "todo--task todo--done" : "todo--task"}
      ...
      >
        ...
        >
          ...
          {props.user.name === props.data.owner && (
            <IconButton
              size="small"
              onClick={() => props.handleEditClick(props.data, props.order)}
            >
              <EditIcon />
            </IconButton>
          )}
      ...
      <div className="todo--sorting">
        {props.order > 0 && (
          <IconButton
            ...
            onClick={() => props.swapTasks(props.order - 1)}
          >
            <KeyboardArrowUpIcon />
          </IconButton>
        )}
        {props.order < props.user.tasks.length - 1 && (
          <IconButton
            size="small"
            sx={{ width: "100%", padding: 0 }}
            onClick={() => props.swapTasks(props.order)}
          >
